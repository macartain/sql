...
select job_type_name, jhf.JOB_ID,j.process_instance_id ppid, jhf.MANAGED_FILE_ID, jhf.JOB_FILE_NUMBER jfn, 
decode(nvl(j.JOB_STATUS, 0),
                 ...
                 4,      'Cancelled',
                 5,      'Being edited',
                 6,      'Superseded') jobfile_status,
                 job_priority pri, to_char(CREATED_DTM, 'YYYYMONDD-HH24:MM') created,
                 to_char(jhf.LAST_UPDATE_DTM, 'YYYYMONDD-HH24:MM') updated, PROCESSED_TIDEMARK proc, VALID_TIDEMARK valid
