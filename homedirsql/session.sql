...
SELECT nvl(vs.username, '-') "user", osuser, vs.sid||','||vs.serial# "SID,serial", process "ps PID", type, status, vs.PROGRAM, sql_id, SQL_CHILD_NUMBER child, vp.spid "Shadow PID", TO_CHAR(LOGON_TIME,'DDMON-hh24:mi:ss') logon
from v$session vs 
