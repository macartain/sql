--TODO:
-- systimestamp instead of sysdate
...
declare
    ...
    output_username number := 1;
    output_sid      number := 1;
    output_time     number := 0;
    output_seconds  number := 0;
    output_stype    number := 1;
    output_sname    number := 1;
    output_delta    number := 1;
    output_delta_s  number := 0;
    output_hdelta   number := 0;
    output_hdelta_s number := 1;
    output_percent  number := 1;
    output_pcthist  number := 1;
...
begin
    ...
    if pagesize > 0 then
        output(' ');
        output('-- Session Snapper v2.00 by Tanel Poder ( http://www.tanelpoder.com )');
        output(' ');
    end if;
