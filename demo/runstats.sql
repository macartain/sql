...
-- 
-- You should note also that the LATCH information is collected on a SYSTEM WIDE basis. If you run this on a multi-user system, the 
-- latch information may be technically "incorrect" as you will count the latching information for other sessions - not just your 
-- session. This test harness works best in a simple, controlled test environment. 
